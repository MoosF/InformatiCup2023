...
public class FieldTest extends TestCase {
    ...
    public void testAddBaseObject() throws CouldNotPlaceObjectException {
        ...
        assertThrows(
            CouldNotRemoveObjectException.class, () -> field.addBaseObject(Mine.createMine(0,0, MineSubType.OUTPUT_EAST)));
    ...
    public void testRemoveBaseObject() throws CouldNotPlaceObjectException, CouldNotRemoveObjectException {
        assertThrows(CouldNotRemoveObjectException.class, () -> field.removeBaseObject(Mine.createMine(0,0, MineSubType.OUTPUT_EAST)));
