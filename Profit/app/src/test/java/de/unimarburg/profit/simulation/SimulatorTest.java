...
class SimulatorTest {
  ...
  public void test1() throws CouldNotPlaceObjectException, SimulateException {
    ...
    field.addBaseObject(Conveyer.createConveyor(8, 2, ConveyorSubType.SHORT_OUTPUT_EAST));
    field.addBaseObject(Conveyer.createConveyor(11, 2, ConveyorSubType.SHORT_OUTPUT_EAST));
  ...
  public void test2() throws CouldNotPlaceObjectException, SimulateException {
    ...
    field.addBaseObject(Conveyer.createConveyor(9, 4, ConveyorSubType.SHORT_OUTPUT_SOUTH));
    field.addBaseObject(Conveyer.createConveyor(9, 7, ConveyorSubType.SHORT_OUTPUT_SOUTH));
    field.addBaseObject(Conveyer.createConveyor(9, 10, ConveyorSubType.SHORT_OUTPUT_SOUTH));
    field.addBaseObject(Conveyer.createConveyor(9, 13, ConveyorSubType.SHORT_OUTPUT_SOUTH));
    field.addBaseObject(Conveyer.createConveyor(13, 16, ConveyorSubType.SHORT_OUTPUT_EAST));
    field.addBaseObject(Conveyer.createConveyor(16, 16, ConveyorSubType.SHORT_OUTPUT_EAST));
  ...
  public void test3() throws CouldNotPlaceObjectException, SimulateException {
    ...
    field.addBaseObject(Conveyer.createConveyor(13, 2, ConveyorSubType.SHORT_OUTPUT_EAST));
    field.addBaseObject(Conveyer.createConveyor(14, 4, ConveyorSubType.SHORT_OUTPUT_SOUTH));
    field.addBaseObject(Conveyer.createConveyor(16, 5, ConveyorSubType.SHORT_OUTPUT_EAST));
    ...
    field.addBaseObject(Conveyer.createConveyor(26, 2, ConveyorSubType.SHORT_OUTPUT_WEST));
    field.addBaseObject(Conveyer.createConveyor(25, 4, ConveyorSubType.SHORT_OUTPUT_SOUTH));
    field.addBaseObject(Conveyer.createConveyor(24, 6, ConveyorSubType.SHORT_OUTPUT_WEST));
    ...
    field.addBaseObject(Conveyer.createConveyor(13, 17, ConveyorSubType.SHORT_OUTPUT_EAST));
    field.addBaseObject(Conveyer.createConveyor(14, 15, ConveyorSubType.SHORT_OUTPUT_NORTH));
    field.addBaseObject(Conveyer.createConveyor(16, 14, ConveyorSubType.SHORT_OUTPUT_EAST));
    ...
    field.addBaseObject(Conveyer.createConveyor(26, 17, ConveyorSubType.SHORT_OUTPUT_WEST));
    field.addBaseObject(Conveyer.createConveyor(25, 15, ConveyorSubType.SHORT_OUTPUT_NORTH));
    field.addBaseObject(Conveyer.createConveyor(24, 13, ConveyorSubType.SHORT_OUTPUT_WEST));
  ...
  public void test4() throws SimulateException, CouldNotPlaceObjectException {
    ...
    field.addBaseObject(Conveyer.createConveyor(8, 12, ConveyorSubType.LONG_OUTPUT_EAST));
    field.addBaseObject(Conveyer.createConveyor(12, 12, ConveyorSubType.SHORT_OUTPUT_EAST));
    field.addBaseObject(Conveyer.createConveyor(15, 12, ConveyorSubType.SHORT_OUTPUT_EAST));
    field.addBaseObject(Conveyer.createConveyor(18, 12, ConveyorSubType.SHORT_OUTPUT_EAST));
    ...
    field.addBaseObject(Conveyer.createConveyor(12, 8, ConveyorSubType.LONG_OUTPUT_SOUTH));
    field.addBaseObject(Conveyer.createConveyor(12, 12, ConveyorSubType.SHORT_OUTPUT_SOUTH));
    field.addBaseObject(Conveyer.createConveyor(12, 15, ConveyorSubType.SHORT_OUTPUT_SOUTH));
    field.addBaseObject(Conveyer.createConveyor(12, 18, ConveyorSubType.SHORT_OUTPUT_SOUTH));
